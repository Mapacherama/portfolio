<template>
      ...
      <div class="contact-card">
        ...
        <form id="contact-form" class="contact-fields">
          ...
          <div class="form-group">
            ...
            <input type="text" id="from_name" name="from_name" v-model.trim="formData.from_name" placeholder="John Doe" required />
          </div>
          <div class="form-group">
            <label for="email">Your Email</label>
            <input type="email" id="email" name="email" v-model.trim="formData.email" placeholder="john.doe@example.com" required />
          </div>
          <div class="form-group">
            <label for="message">Your Message</label>
            <textarea id="message" name="message" rows="4" v-model.trim="formData.message" placeholder="Type your message here..." required></textarea>
          </div>
          <div>
  ...
  .dark .contact-fields input, .dark .contact-fields textarea {
    background: #333;
    color: #ffffff;
